...
export default function ViewDonationsOrganization() {
    ...
    function handleDelete(id:any) {
        ...
        setResults(newRes);
        const filteredResults = filterDonations(newRes, column1, value1, column2, value2) || [];    
    ...
    useEffect(() => {
        const filtered = filterDonations(results, column1, value1, column2, value2) || [];
                        ...
                        <div>
                            ...
                            <div className="flex flex-row justify-between">
                                <div className="align-middle m-1">
                                    <Chip onClose={closeFilterCategory} variant="bordered" className={categoryChip}><div className="flex flex-row"><p className="font-bold">Category:</p>{filterCol1}</div></Chip>
                                ...
                                <div className="w-[240]">
                                    <SearchBar query={query} handleSearch={handleSearch} placeHolder="Search by Donation"/>
                                </div>
                            </div>
                    </div>
                    <DonationTable donations={displayedResults} columns={columns} deleteFunction={handleDelete} />
                </div>
            </div>
        </div>
    );
