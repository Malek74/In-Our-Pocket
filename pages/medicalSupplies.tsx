...
export default function MedicalSuppliesViewer() {
  ...
  const [results, setResults] = useState(medicalSuppliesUsers);
  const [filteredResults, setFilteredResults] = useState(medicalSuppliesUsers);
  const [displayedResults, setDisplayedResults] =
    useState(medicalSuppliesUsers);
      ...
      <div className="flex flex-row flex-1">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <RequestTable
            ...
            columns={medicalSuppliesColumns}
