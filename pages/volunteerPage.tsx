...
import { Button, Pagination, Breadcrumbs, BreadcrumbItem, Link } from "@nextui-org/react";
                            ...
                            <div className="mx-12 my-12 flex justify-between">
                                ...
                                <div className="w-3/4 mx-4 my-2 flex-col ">
                                    ...
                                    <div className="flex justify-start ml-24">
                                        ...
                                        <h2 className="text-4xl font-large text-default-400 ml-3">{Expertise}</h2>
                                    </div>

                                    <div className="flex justify-start ml-24">
                                        <CakeOutlined className="fill-[#A1A1AA] ml-1 mt-2" />
                                        <h2 className="text-3xl font-large text-default-400 ml-3">{DOB} ({Age})</h2>
                                    </div>
                                </div>
                                                ...
                                                <div id="insideText" className="p-[20px] border-[1px] border-[solid] border-[#DDDDDD] rounded-lg -mt-[10px]">
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <div className="flex justify-start ">
                                                            ...
                                                            <p><span className="font-semibold text-default-400 ml-2">{Email}</span></p>
                                                        </div>

                                                        <div className="flex justify-start">
                                                            <LocalPhoneOutlined className="fill-gray" />
                                                            <p><span className="font-semibold text-default-400 ml-2">Number: {Number}</span></p>
                                                        </div>
                                                    </div>
