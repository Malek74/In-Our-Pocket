                    ...
                    <div>
                        ...
                        <div className="flex flex-row ">
                            ...
                            <div className="border-solid border-2 m-2 rounded-xl min-w-[500px] min-h-[296px]">
                                ...
                                <Image src={donationsChart}  alt={"Number of Donation"} className="m-2 border-solid" />
                            </div>
                            ...
                            <div className="border-solid border-2 m-2 rounded-xl">
                                ...
                                <Image src={numberOfDonation}  alt={"Number of Donations this Month"} className="m-2 border-solid" />
                            </div>
                        </div>
                    </div>
