...
export default function MedicalCasesViewer() {
  ...
  const [results, setResults] = useState(medicalCasesUsers);
  const [filteredResults, setFilteredResults] = useState(medicalCasesUsers);
  const [displayedResults, setDisplayedResults] = useState(medicalCasesUsers);
