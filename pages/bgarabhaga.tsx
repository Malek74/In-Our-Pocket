                        ...
                        <Card className="flex flex-col justify-left items-left gap-4 p-6 bg-rose rounded-lg shadow-md" style={{ width: '30%', minWidth: '350px' }}>
                            <div className="flex flex-col">
                                <div className="flex items-center">
                                    <p className="text-2xl text-black font-bold mr-2 mt-4">Type: </p>
                                    <p className="text-2xl text-black gap-10  mt-4">Jeans</p>
                                </div>
                                <div className="flex items-center">
                                    <p className="text-2xl text-black font-bold mr-2 mt-4">Gender: </p>
                                    <p className="text-2xl text-black gap-10 mt-4"> Male</p>
                                </div>
                                <div className="flex items-center">
                                    <p className="text-2xl text-black font-bold mr-2 mt-4">Age: </p>
                                    <p className="text-2xl text-black gap-10 mt-4"> 10-15 years old </p>
                                </div>
                                <div className="flex items-center">
                                    <p className="text-2xl text-black font-bold mr-2 mt-4">Season:</p>
                                    <p className="text-2xl text-black gap-10 mt-4"> All seasons</p>
                                </div>
                                <div className="flex items-center">
                                    <p className="text-2xl text-black font-bold mr-2 mt-4">Material:</p>
