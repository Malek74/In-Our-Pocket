      ...
      <div className="mx-12 my-12 flex justify-between">
        ...
        <div className="w-3/4 mx-4 my-2 flex-col">
          ...
          <div className="flex justify-start ml-24">
            ...
            <h3 className="text-2xl font-large ml-2 text-default-400">
              Address
            </h3>
          </div>
          ...
          <div className="flex justify-start ml-24">
            ...
            <h5 className="text-2xl font-large ml-2 text-default-400">
              Governate
            </h5>
          </div>
        </div>
          ...
          <div className="flex justify-center mb-4 mx-12 ">
            ...
            <div className="w-1/2 pl-8 pr-8">
              ...
              <div className="pr-12 pl-12">
                <div
                  id="headerText"
                  className="relative bg-[#FFF] text-center z-1000 w-[240px] mx-[auto] my-[0] font-bold"
                >
            ...
            <div className="w-1/2 pl-8 pr-8 ">
              ...
              <div className="pl-12 pr-12">
                <div
                  id="headerText"
                  className="relative bg-[#FFF] text-center z-1000 w-[280px] mx-[auto] my-[0] font-bold"
                >
