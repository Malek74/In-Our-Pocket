...
export const Navbar = (props:any) => {
  switch(props.user){
    case "donor":
      return  (       <NextUINavbar maxWidth="full" position="sticky" className="bg-blue-400">
      <NavbarContent
      ...
      <NavbarContent className="basis-1/5 sm:basis-full" justify="end">
        ...
        <NavbarMenuItem>
          <Dropdown placement="bottom-end">
            <DropdownTrigger>
              <div className="flex justify-center items-center p-2 rounded-xl hover:bg-cyanDark ">
                <Avatar />
    ...
    case "org":
      return(
        <NextUINavbar maxWidth="full" position="sticky" className="bg-cyanDark">
        <NavbarContent
          className="basis-1/5 sm:basis-full flex-none"
          justify="start"
        >
    ...
    default:
      return(        <NextUINavbar maxWidth="full" position="sticky" className="bg-blue-300">
      <NavbarContent
        className="basis-1/5 sm:basis-full flex-none"
        justify="start"
      >
