...
function FilterMenueOption1(props: any) {
  ...
  <Popover className="relative rounded-sm">
      <Popover.Button className="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 rounded-sm rounded-xl hover:bg-mint">
      ...
      >
        <Popover.Panel className="absolute left-1/2  z-10 transform -translate-x-1/2 bg-rose rounded-xl  w-[200px] mt-2 ">
...
<Popover className="relative rounded-sm">
    ...
    <Transition
      ...
      leaveTo="opacity-0 translate-y-0"
    >
      <Popover.Panel className="absolute left-1/2  z-10 transform -translate-x-1/2 bg-rose rounded-xl  w-[300px] mt-2 ">
